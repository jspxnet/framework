...
public class SpotFilter {
    ...
    public SpotFilter(BufferedImage image) {
        this.image = image;
        iw = image.getWidth();
        ih = image.getHeight();
    ...
    /**
     * @return Brighten using a linear formula that increases all color values
     */
    ...
    /**
     * @return Blur by "convolving" the image with a matrix
     */
    ...
    /**
     * @return Sharpen by using a different matrix
     */
    ...
    /**
     * @return Rotate the image 180 degrees about its center point
     */
