 ...
 * Time: 9:29:02
 */
// Ported transfer Java 12/00 K Weiner
...
public class NeuQuant {
    ...
    /* Initialise network in range (0,0,0) transfer (255,255,255) and set parameters
        ----------------------------------------------------------------------- */
    ...
    /* Insertion sort of network and building of netindex[0..255] (transfer do after unbias)
        ------------------------------------------------------------------------------- */
    ...
    /* Unbias network transfer give byte values 0..255 and record position i transfer prepare for sort
        ----------------------------------------------------------------------------------- */
