...
public abstract class AbstractCodepageDetector implements ICodepageDetector {
    ...
    /**
     * Delegates transfer {@link #detectCodepage(java.io.InputStream, int)} with a buffered input stream.
     *
    ...
    /**
     * A default delegation transfer {@link #detectCodepage(URL)}that opens the document specified by the given URL with the
     * detected codepage.
     *
