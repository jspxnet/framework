 ...
 **/
@Slf4j
public class SaveObjectCmd  extends BaseCmdRun {
    public final static String name = BaseRedisStoreQueue.CMD_SAVE;
    ...
    public void execute() throws Exception
    {
       ...
       if (ClassUtil.isStandardType(cls))
        ...
        storeQueueStatus.setCmd(name);
        try {
            storeQueueStatus.setResult(genericDAO.save(obj));
