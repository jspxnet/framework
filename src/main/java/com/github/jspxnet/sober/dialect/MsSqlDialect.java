...
public class MsSqlDialect extends Dialect {
    public MsSqlDialect() {
        ...
        put(String.class.getName(), "[${" + COLUMN_NAME + "}] <#if where=" + COLUMN_LENGTH + "&gt;1000>[ntext]<#else>[varchar] (${" + COLUMN_LENGTH + "})</#else></#if> <#if where=" + COLUMN_NOT_NULL + ">NOT NULL<#else>NULL</#else></#if> <#if where=" + COLUMN_DEFAULT + ">default '${" + COLUMN_DEFAULT + "}'</#if>");
        ...
        put(Double.class.getName(), "[${" + COLUMN_NAME + "}] [real] <#if where=" + COLUMN_NOT_NULL + ">NOT NULL<#else>NULL</#else></#if> default <#if where=!" + COLUMN_DEFAULT + " >'0'<#else>'${" + COLUMN_DEFAULT + "}'</#else></#if>");
        put("double", "[${" + COLUMN_NAME + "}] <#if where=" + COLUMN_LENGTH + "&gt;15>double(${" + COLUMN_LENGTH + "},3)<#else>double(15,3)</#else></#if> <#if where=" + COLUMN_NOT_NULL + ">NOT NULL<#else>NULL</#else></#if> default <#if where=!" + COLUMN_DEFAULT + " >'0'<#else>'${" + COLUMN_DEFAULT + "}'</#else></#if>");

        put(Float.class.getName(), "[${" + COLUMN_NAME + "}] [float] <#if where=" + COLUMN_NOT_NULL + ">NOT NULL<#else>NULL</#else></#if> default <#if where=!" + COLUMN_DEFAULT + " >'0'<#else>'${" + COLUMN_DEFAULT + "}'</#else></#if>");
        put("float", "[${" + COLUMN_NAME + "}] [float] <#if where=" + COLUMN_NOT_NULL + ">NOT NULL<#else>NULL</#else></#if> default <#if where=!" + COLUMN_DEFAULT + " >'0'<#else>'${" + COLUMN_DEFAULT + "}'</#else></#if>");
